  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded shadow">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-black">Full-stack Cover Letter</h1>
        <button
          onClick={handleCopy}
      ...
      {isEditing ? (
        <textarea
          className="w-full text-black h-64 p-4 border border-gray-300 rounded mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
          value={text}
